package com.echronos.epoandroid.module_order.mvp.ui.fragment;
...
public class OrderListManagerAllFragment extends BaseLoadLayoutFragment<OrderListManagerAllPresenter> implements OrderListManagerAllContract.View {
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerOrderListManagerAllComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_order_list_manager_all, container, false);
    }
