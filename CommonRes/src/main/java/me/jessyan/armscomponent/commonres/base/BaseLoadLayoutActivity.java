 ...
 * 继承于这个特定的 {@link Activity}, 然后再按照 {@link BaseLoadLayoutActivity} 的格式, 将代码复制过去, 记住一定要实现{@link IActivity}
 *
 ...
 * ================================================
 */
public abstract class BaseLoadLayoutActivity<P extends IPresenter> extends AppCompatActivity implements IActivity, ActivityLifecycleable, LoadlayoutViewInflater {
    ...
    protected void onCreate(@Nullable final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.public_base_loadlayout);
