package com.echronos.epoandroid.module_cart.mvp.ui.fragment;
...
import com.echronos.epoandroid.module_cart.di.component.DaggerShoppingCartAllComponent;
import com.echronos.epoandroid.module_cart.mvp.contract.ShoppingCartAllContract;
import com.echronos.epoandroid.module_cart.mvp.presenter.ShoppingCartAllPresenter;
...
public class ShoppingCartAllFragment extends BaseLoadLayoutFragment<ShoppingCartAllPresenter> implements ShoppingCartAllContract.View {
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerShoppingCartAllComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_shopping_cart_all, container, false);
    }
